  ...
  return (
    <main className="max-w-5xl mx-auto px-6 py-10">
            ...
            <div className="flex items-center gap-4">
              ...
              <p className="text-gray-500">
                {subscription.plan === "premium" ? (
                  <>
                    <span className="text-[#111111] font-semibold">Illimitées</span>{" "}
                    générations
                  </>
                ) : (
                  <>
                    <span className="text-[#111111] font-semibold">{remaining}</span>{" "}
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h2 className="text-3xl font-bold text-[#111111]">Mes stratégies</h2>
      ...
      {!strategies || strategies.length === 0 ? (
        <div className="bg-white border border-gray-200 rounded-2xl p-12 text-center shadow-sm">
          <svg xmlns="http://www.w3.org/2000/svg" className="w-16 h-16 text-gray-300 mx-auto mb-4" fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor">
        ...
        <div className="grid gap-4">
          {strategies.map((strategy) => (
            <Link
              ...
              className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:border-violet-500/30 transition-all group"
            >
              <div className="flex items-center justify-between">
                <div className="flex-1 min-w-0">
                  <h3 className="text-lg font-semibold text-[#111111] group-hover:text-violet-400 transition-colors truncate">
                ...
                <div className="flex items-center gap-2 flex-shrink-0 ml-4">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-gray-400 group-hover:text-violet-400 transition-colors" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
