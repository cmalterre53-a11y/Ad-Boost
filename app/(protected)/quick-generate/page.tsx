      ...
      <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {POST_TYPES.map((type) => (
              <button
                ...
                className={`flex items-center gap-2.5 px-4 py-3 rounded-xl border text-sm font-medium transition-all ${
                  typePost === type.id
                    ? "bg-amber-600/20 border-amber-500/50 text-amber-600 shadow-md shadow-amber-500/10"
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
          ...
          <textarea
            ...
            required
            rows={3}
            className="w-full px-4 py-3 bg-white border border-gray-300 rounded-xl text-[#111111] placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500/50 transition resize-none"
          />
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
          ...
          <select
            ...
            className="w-full px-4 py-3 bg-white border border-gray-300 rounded-xl text-[#111111] focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500/50 transition appearance-none"
          >
            <option value="">
              Aucune stratégie
            </option>
          ...
          {selectedStrat && (
            <div className="flex flex-wrap gap-2 mt-3">
              <span className="px-2.5 py-1 text-xs bg-amber-500/15 text-amber-600 border border-amber-500/25 rounded-full">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            {legendes.map((legende, i) => (
              <div
                key={i}
                className="flex items-start gap-3 bg-white border border-gray-200 rounded-xl px-4 py-4 shadow-sm"
              >
                ...
                <p className="text-[#111111] flex-1 whitespace-pre-line text-sm leading-relaxed">
                  {legende}
                </p>
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-3 bg-white border border-gray-200 hover:border-amber-500/50 text-gray-500 hover:text-amber-600 font-medium rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
