...
const plans = [
  ...
  },
  {
    ...
    features: [
      ...
      "5 accroches + 5 textes de pub + 5 visuels + 5 légendes par génération",
  ...
  },
  {
    ...
    features: [
      ...
      "Historique des générations sauvegardé",
      "Analyse de tes résultats et recommandations pour améliorer tes performances",
    ],
